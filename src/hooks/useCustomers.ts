...
export const useCustomers = () => {
  const [customers, setCustomers] = useState<Record<string, CustomerWithExercises>>({})
  ...
  const addCustomer = (newCustomer: CustomerData) => {
    const exercisesMapper: Record<PossibleSex, Array<ExerciseSet>> = {
      F: [exerciseLists['woman-lose-weight-a-id'], exerciseLists['woman-lose-weight-c-id']],
      M: [exerciseLists['man-lose-weight-a-id'], exerciseLists['man-lose-weight-b-id'], exerciseLists['man-lose-weight-c-id']],
    }
